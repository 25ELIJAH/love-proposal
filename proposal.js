...
if (!encoded) {
  ...
  downloadBtn.addEventListener('click', function() {
    ...
    doc.text(`${data.receiver}'s Proposal Letter`, pageWidth / 2, 24, { align: 'center' });
    ...
    const dateStr = `Written on this day, the ${now.getDate()}th of ${months[now.getMonth()]}, in the year ${now.getFullYear()} — at ${hour12}:${minutes} ${ampm}`;
  ...
  yesBtn.addEventListener('click', function() {
    ...
    fireworksEl.style.cssText = 'position:fixed;inset:0;pointer-events:none;z-index:0;';
    overlay.appendChild(fireworksEl);
    ...
    card.innerHTML = `
      <div style="font-size:56px;animation:heartbeat 1s infinite;display:block;margin-bottom:0.5rem;">💍</div>
      ...
      <div style="font-size:26px;letter-spacing:4px;margin:0.8rem 0;">
        🎉💖🥂✨🌹🎊💍🎀
      </div>
      ...
      <p style="
        ...
        line-height:1.8;
        margin-bottom:1rem;
      ">${data.receiver}, you just made ${data.sender} the luckiest person alive. 💍<br/>Your love story has just begun.</p>
    ...
    launchFirework();
    const fw = setInterval(launchFirework, 600);
